...
**/
package godot;
@:generated_godot_api @:bindings_api_type("builtin_classes") @:indexing_return_type("String") @:is_keyed(false) @:has_destructor(true) @:copyType @:noCompletion @:avoid_temporaries @:nativeName("String") extern class GodotString_Fields {
	...
	@:is_static(true)
	@:hash(2710373411.)
	@:nativeName("num_scientific")
	public static function num_scientific(@:default_value(null) number:Float):String;
	@:is_vararg(false)
	@:is_const(false)
	@:is_static(true)
	@:hash(1555901022)
	@:nativeName("num")
	public static function num(@:default_value(null) number:Float, @:default_value("-1") ?decimals:Int):String;
	@:is_vararg(false)
	@:is_const(false)
	@:is_static(true)
	@:hash(2111271071)
	@:nativeName("num_int64")
	public static function num_int64(@:default_value(null) number:Int, @:default_value("10") ?base:Int, @:default_value("false") ?capitalize_hex:Bool):String;
	@:is_vararg(false)
	@:is_const(false)
	@:is_static(true)
	@:hash(2111271071)
	@:nativeName("num_uint64")
	public static function num_uint64(@:default_value(null) number:Int, @:default_value("10") ?base:Int, @:default_value("false") ?capitalize_hex:Bool):String;
	@:is_vararg(false)
	@:is_const(false)
	@:is_static(true)
	@:hash(897497541)
	@:nativeName("chr")
	public static function chr(@:default_value(null) code:Int):String;
	@:is_vararg(false)
	@:is_const(false)
	@:is_static(true)
	@:hash(897497541)
	@:nativeName("humanize_size")
	public static function humanize_size(@:default_value(null) size:Int):String;
}