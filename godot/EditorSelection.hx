...
@:generated_godot_api @:bindings_api_type("class") @:is_refcounted(false) @:is_instantiable(true) @:api_type("editor") @:is_resource(false) @:is_node(false) extern class EditorSelection extends godot.Object {
	...
	@:hash(2915620761.)
	@:hash_compatibility(null)
	@:nativeName("get_top_selected_nodes")
	public function get_top_selected_nodes():Array<godot.Node>;
	@:return_value_meta(null)
	@:is_const(false)
	@:is_static(false)
	@:is_vararg(false)
	...
	@:hash(2915620761.)
	@:hash_compatibility(null)
	@:nativeName("get_transformable_selected_nodes")
