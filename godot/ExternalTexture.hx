...
**/
package godot;
@:generated_godot_api @:bindings_api_type("class") @:is_refcounted(true) @:is_instantiable(true) @:api_type("core") @:is_resource(true) @:is_node(false) extern class ExternalTexture extends godot.Texture2D {
	public function new();
#if use_properties
	@:index(null)
	@:getter("get_size")
	...
	@:hash(3905245786.)
	@:hash_compatibility(null)
	@:nativeName("get_external_texture_id")
	...
	@:hash(1286410249)
	@:hash_compatibility(null)
	@:nativeName("set_external_buffer_id")
	@:argMeta(0, ":meta"("uint64"))
	public function set_external_buffer_id(@:meta("uint64") external_buffer_id:Int):Void;
}