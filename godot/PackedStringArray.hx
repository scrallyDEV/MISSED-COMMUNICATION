...
**/
package godot;
@:forward @:forward.new @:forwardStatics @:copyType extern abstract PackedStringArray(godot.PackedStringArray_Fields) {
	@:arrayAccess
	...
	@:op(A in B)
	public static inline function inOp2(self:godot.PackedStringArray, other:GodotArray):Bool {
		return untyped #if gdscript __gdscript__ #else __cpp__ #end("(({0}) in ({1}))", self, other);
	}
	@:op(A == B)
