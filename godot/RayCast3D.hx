...
@:generated_godot_api @:bindings_api_type("class") @:is_refcounted(false) @:is_instantiable(true) @:api_type("core") @:is_resource(false) @:is_node(true) extern class RayCast3D extends godot.Node3D {
	...
	@:hash(3218959716.)
	@:hash_compatibility(null)
	@:nativeName("force_raycast_update")
	...
	@:hash(3905245786.)
	@:hash_compatibility(null)
	@:nativeName("get_collision_face_index")
	...
	@:hash(2586408642.)
	@:hash_compatibility(null)
	@:nativeName("set_hit_from_inside")
	...
	@:hash(36873697)
	@:hash_compatibility(null)
	@:nativeName("is_hit_from_inside_enabled")
	...
	@:hash(36873697)
	@:hash_compatibility(null)
	@:nativeName("is_hit_back_faces_enabled")
	...
	@:hash(1286410249)
	@:hash_compatibility(null)
	@:nativeName("set_debug_shape_thickness")
	...
	@:hash(3905245786.)
	@:hash_compatibility(null)
	@:nativeName("get_debug_shape_thickness")
