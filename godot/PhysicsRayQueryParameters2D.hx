...
@:generated_godot_api @:bindings_api_type("class") @:is_refcounted(true) @:is_instantiable(true) @:api_type("core") @:is_resource(true) @:is_node(false) extern class PhysicsRayQueryParameters2D extends godot.RefCounted {
	...
	#if gdscript @:argMeta(2, ":noNullPad"("4294967295")) #end
	@:argMeta(3, ":default_value"("Array[RID]([])"))
	#if gdscript @:argMeta(3, ":noNullPad"("[]")) #end
	public static function create(from:godot.Vector2, to:godot.Vector2, @:meta("uint32") @:default_value("4294967295") #if gdscript @:noNullPad("4294967295") #end collision_mask:Int = null, @:default_value("Array[RID]([])") #if gdscript @:noNullPad("[]") #end ?exclude:Array<godot.RID>):godot.PhysicsRayQueryParameters2D;
#if use_properties
