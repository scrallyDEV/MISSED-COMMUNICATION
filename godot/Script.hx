...
@:generated_godot_api @:bindings_api_type("class") @:is_refcounted(true) @:is_instantiable(false) @:api_type("core") @:is_resource(true) @:is_node(false) extern class Script extends godot.Resource {
	...
	public function reload(@:default_value("false") #if gdscript @:noNullPad("false") #end keep_state:Bool = false):godot.Error;
	@:return_value_meta(null)
	@:is_const(true)
	@:is_static(false)
	@:is_vararg(false)
	...
	@:hash(2002593661)
	@:hash_compatibility(null)
	@:nativeName("get_instance_base_type")
	...
	@:hash(2002593661)
	@:hash_compatibility(null)
	@:nativeName("get_global_name")
	public function get_global_name():godot.StringName;
	@:return_value_meta(null)
	@:is_const(true)
	@:is_static(false)
	@:is_vararg(false)
	...
	@:hash(2619796661.)
	@:hash_compatibility(null)
	@:nativeName("has_script_method")
	public function has_script_method(method_name:godot.StringName):Bool;
	@:return_value_meta(null)
	@:is_const(true)
	@:is_static(false)
	@:is_vararg(false)
	...
	@:hash(2915620761.)
	@:hash_compatibility(null)
	@:nativeName("get_script_property_list")
	...
	@:hash(2915620761.)
	@:hash_compatibility(null)
	@:nativeName("get_script_method_list")
	...
	@:hash(2915620761.)
	@:hash_compatibility(null)
	@:nativeName("get_script_signal_list")
	...
	@:hash(2382534195.)
	@:hash_compatibility(null)
	@:nativeName("get_script_constant_map")
	...
	@:hash(2138907829)
	@:hash_compatibility(null)
	@:nativeName("get_property_default_value")
	...
	@:hash(1214101251)
	@:hash_compatibility(null)
	@:nativeName("get_rpc_config")
	public function get_rpc_config():Dynamic;
	@:return_value_meta(null)
	@:is_const(true)
	@:is_static(false)
	@:is_vararg(false)
