...
@:generated_godot_api @:bindings_api_type("class") @:is_refcounted(true) @:is_instantiable(true) @:api_type("core") @:is_resource(true) @:is_node(false) extern class Curve3D extends godot.Resource {
	...
	public function add_point(position:godot.Vector3, @:default_value("Vector3(0, 0, 0)") #if gdscript @:noNullPad("Vector3(0, 0, 0)") #end ?_in:godot.Vector3, @:default_value("Vector3(0, 0, 0)") #if gdscript @:noNullPad("Vector3(0, 0, 0)") #end ?out:godot.Vector3, @:meta("int32") @:default_value("-1") #if gdscript @:noNullPad("-1") #end index:Int = -1):Void;
	@:is_const(false)
	@:is_static(false)
	@:is_vararg(false)
	@:is_virtual(false)
	...
	@:hash(2586408642.)
	@:hash_compatibility(null)
	@:nativeName("set_up_vector_enabled")
	...
	@:hash(36873697)
	@:hash_compatibility(null)
	@:nativeName("is_up_vector_enabled")
	...
	public function sample_baked(@:meta("float") @:default_value("0.0") #if gdscript @:noNullPad("0.0") #end offset:Float = 0., @:default_value("false") #if gdscript @:noNullPad("false") #end cubic:Bool = false):godot.Vector3;
	@:return_value_meta(null)
	@:is_const(true)
	@:is_static(false)
	@:is_vararg(false)
	...
	public function sample_baked_with_rotation(@:meta("float") @:default_value("0.0") #if gdscript @:noNullPad("0.0") #end offset:Float = 0., @:default_value("false") #if gdscript @:noNullPad("false") #end cubic:Bool = false, @:default_value("false") #if gdscript @:noNullPad("false") #end apply_tilt:Bool = false):godot.Transform3D;
	@:return_value_meta(null)
	@:is_const(true)
	@:is_static(false)
	@:is_vararg(false)
	...
	@:hash(1362627031)
	@:hash_compatibility(null)
	@:nativeName("sample_baked_up_vector")
	@:argMeta(0, ":meta"("float"))
	@:argMeta(1, ":default_value"("false"))
	#if gdscript @:argMeta(1, ":noNullPad"("false")) #end
	public function sample_baked_up_vector(@:meta("float") offset:Float, @:default_value("false") #if gdscript @:noNullPad("false") #end apply_tilt:Bool = false):godot.Vector3;
	@:return_value_meta(null)
	@:is_const(true)
	@:is_static(false)
	@:is_vararg(false)
	...
	@:hash(497664490)
	@:hash_compatibility(null)
	@:nativeName("get_baked_up_vectors")
	...
	public function tessellate(@:meta("int32") @:default_value("5") #if gdscript @:noNullPad("5") #end max_stages:Int = 5, @:meta("float") @:default_value("4") #if gdscript @:noNullPad("4") #end tolerance_degrees:Float = 4.):godot.PackedVector3Array;
	@:return_value_meta(null)
	@:is_const(true)
	@:is_static(false)
	@:is_vararg(false)
	...
	public function tessellate_even_length(@:meta("int32") @:default_value("5") #if gdscript @:noNullPad("5") #end max_stages:Int = 5, @:meta("float") @:default_value("0.2") #if gdscript @:noNullPad("0.2") #end tolerance_length:Float = 0.2):godot.PackedVector3Array;
}