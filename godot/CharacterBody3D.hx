...
@:generated_godot_api @:bindings_api_type("class") @:is_refcounted(false) @:is_instantiable(true) @:api_type("core") @:is_resource(false) @:is_node(true) extern class CharacterBody3D extends godot.PhysicsBody3D {
	...
	#if gdscript @:argMeta(0, ":noNullPad"("Vector3(0, 1, 0)")) #end
	public function get_floor_angle(@:default_value("Vector3(0, 1, 0)") #if gdscript @:noNullPad("Vector3(0, 1, 0)") #end ?up_direction:godot.Vector3):Float;
	@:return_value_meta(null)
	@:is_const(true)
	@:is_static(false)
	@:is_vararg(false)
	...
	@:hash(3360562783.)
	@:hash_compatibility(null)
	@:nativeName("get_platform_angular_velocity")
