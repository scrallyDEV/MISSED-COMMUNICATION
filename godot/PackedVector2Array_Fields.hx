...
**/
package godot;
@:generated_godot_api @:bindings_api_type("builtin_classes") @:indexing_return_type("Vector2") @:is_keyed(false) @:has_destructor(true) @:copyType @:noCompletion @:avoid_temporaries @:nativeName("PackedVector2Array") extern class PackedVector2Array_Fields {
	...
	@:hash(2609058838.)
	@:nativeName("get")
	public function get(@:default_value(null) index:Int):godot.Vector2;
	@:is_vararg(false)
	@:is_const(false)
	@:is_static(false)
	@:hash(635767250)
	...
	@:hash(4188891560.)
	@:nativeName("erase")
	public function erase(@:default_value(null) value:godot.Vector2):Bool;
}