...
**/
package godot;
@:generated_godot_api @:bindings_api_type("class") @:is_refcounted(false) @:is_instantiable(true) @:api_type("core") @:is_resource(false) @:is_node(false) extern class OpenXRSpatialMarkerTrackingCapability extends godot.OpenXRExtensionWrapper {
	public function new();
	...
	@:nativeName("is_qrcode_supported")
	public function is_qrcode_supported():Bool;
	@:return_value_meta(null)
	@:is_const(false)
	@:is_static(false)
	@:is_vararg(false)
	...
	@:hash(2240911060.)
	@:hash_compatibility(null)
	@:nativeName("is_micro_qrcode_supported")
	public function is_micro_qrcode_supported():Bool;
	@:return_value_meta(null)
	@:is_const(false)
	@:is_static(false)
	@:is_vararg(false)
	...
	@:hash(2240911060.)
	@:hash_compatibility(null)
	@:nativeName("is_aruco_supported")
	public function is_aruco_supported():Bool;
	@:return_value_meta(null)
	@:is_const(false)
	@:is_static(false)
	@:is_vararg(false)
	...
	@:hash(2240911060.)
	@:hash_compatibility(null)
	@:nativeName("is_april_tag_supported")
	public function is_april_tag_supported():Bool;
	@:return_value_meta(null)
	@:is_const(false)
	@:is_static(false)
	@:is_vararg(false)
