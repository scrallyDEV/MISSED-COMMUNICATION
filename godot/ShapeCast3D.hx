...
@:generated_godot_api @:bindings_api_type("class") @:is_refcounted(false) @:is_instantiable(true) @:api_type("core") @:is_resource(false) @:is_node(true) extern class ShapeCast3D extends godot.Node3D {
	...
	@:setter(null)
	public var collision_result(get, never) : GodotArray;
#else

	@:index(null)
	@:getter("get_collision_result")
	@:setter(null)
	public var collision_result : GodotArray;
#end
#if use_properties
	@:index(null)
	...
	@:hash(3218959716.)
	@:hash_compatibility(null)
	@:nativeName("force_shapecast_update")
	...
	@:hash(1740695150)
	@:hash_compatibility(null)
	@:nativeName("get_closest_collision_safe_fraction")
	...
	@:hash(1740695150)
	@:hash_compatibility(null)
	@:nativeName("get_closest_collision_unsafe_fraction")
	...
	@:hash(1976431078)
	@:hash_compatibility(null)
	@:nativeName("add_exception")
	@:argMeta(0, ":meta"("required"))
	public function add_exception(@:meta("required") node:godot.CollisionObject3D):Void;
	@:is_const(false)
	@:is_static(false)
	@:is_vararg(false)
	@:is_virtual(false)
	@:hash(2722037293.)
	@:hash_compatibility(null)
	@:nativeName("remove_exception_rid")
	...
	@:hash(1976431078)
	@:hash_compatibility(null)
	@:nativeName("remove_exception")
	@:argMeta(0, ":meta"("required"))
	public function remove_exception(@:meta("required") node:godot.CollisionObject3D):Void;
	@:is_const(false)
	@:is_static(false)
	@:is_vararg(false)
	@:is_virtual(false)
	...
	@:hash(2586408642.)
	@:hash_compatibility(null)
	@:nativeName("set_exclude_parent_body")
	...
	@:hash(36873697)
	@:hash_compatibility(null)
	@:nativeName("get_exclude_parent_body")
	...
	@:hash(3995934104.)
	@:hash_compatibility(null)
	@:nativeName("get_collision_result")
	public function get_collision_result():GodotArray;
#if use_properties
	...
	@:hash(2920490490.)
	@:hash_compatibility(null)
	@:nativeName("set_debug_shape_custom_color")
	...
	@:hash(3444240500.)
	@:hash_compatibility(null)
	@:nativeName("get_debug_shape_custom_color")
