...
@:generated_godot_api @:bindings_api_type("class") @:is_refcounted(true) @:is_instantiable(true) @:api_type("core") @:is_resource(true) @:is_node(false) extern class Shortcut extends godot.Resource {
	...
	@:nativeName("set_events")
	public function set_events(events:GodotArray):Void;
	...
	@:hash(3995934104.)
	@:hash_compatibility(null)
	@:nativeName("get_events")
	public function get_events():GodotArray;
	@:return_value_meta(null)
	@:is_const(true)
	@:is_static(false)
	@:is_vararg(false)
