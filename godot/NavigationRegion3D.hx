...
@:generated_godot_api @:bindings_api_type("class") @:is_refcounted(false) @:is_instantiable(true) @:api_type("core") @:is_resource(false) @:is_node(true) extern class NavigationRegion3D extends godot.Node3D {
	...
	@:hash(2923361153.)
	@:hash_compatibility(null)
	@:nativeName("set_navigation_mesh")
	...
	@:hash(3216645846.)
	@:hash_compatibility(null)
	@:nativeName("bake_navigation_mesh")
	@:argMeta(0, ":default_value"("true"))
	#if gdscript @:argMeta(0, ":noNullPad"("true")) #end
	public function bake_navigation_mesh(@:default_value("true") #if gdscript @:noNullPad("true") #end on_thread:Bool = true):Void;
	@:return_value_meta(null)
	@:is_const(true)
	@:is_static(false)
	@:is_vararg(false)
